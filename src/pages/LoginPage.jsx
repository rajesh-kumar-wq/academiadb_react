...
export default function LoginPage({ onLogin, onNavigate }) {
  ...
  const handleSubmit = e => {
    ...
    if (password.length < 4)  { setError("Invalid password."); return; }
    onLogin(email);
  };
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="field-row">
            <label className="remember-wrap">
              <input type="checkbox" style={{ accentColor: BRAND_GREEN }} /> Remember me
            </label>
            <span className="forgot-link" onClick={() => onNavigate("forgot")}>Forgot password?</span>
          </div>
